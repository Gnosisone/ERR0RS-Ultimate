...
def run_tool(tool_name: str, args: list, timeout: int = 300,
    ...
    """
    # ── Binary overrides: force a specific path for tools with naming conflicts ──
    import os as _os
...
JUICE_SHOP_KILLCHAIN = [
    ...
    },
    {
        "phase": "recon",
        "tool": "nikto",
        "args": ["-h", JUICE_SHOP_URL, "-C", "all", "-maxtime", "120"],
    ...
    },
    {
        "phase": "scanning",
        "tool": "nuclei",
        "args": ["-u", JUICE_SHOP_URL,
                 "-tags", "owasp,xss,sqli,lfi,rce",
