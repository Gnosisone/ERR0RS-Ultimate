...
// ══ AUTONOMOUS AGENT PANEL — moved to index.html inline script (single source of truth).  Duplicate handlers removed 2026-06-14 to fix the dead Launch Agent button. ══
